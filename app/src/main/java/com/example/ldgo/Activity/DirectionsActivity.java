...
import com.example.ldgo.Adapter.DirectionStepAdapter;
import com.example.ldgo.Constant.AllConstant;
import com.example.ldgo.Model.DirectionPlaceModel.DirectionLegModel;
import com.example.ldgo.Model.DirectionPlaceModel.DirectionResponseModel;
import com.example.ldgo.Model.DirectionPlaceModel.DirectionRouteModel;
import com.example.ldgo.Model.DirectionPlaceModel.DirectionStepModel;
import com.example.ldgo.Model.GooglePlaceModel.GoogleResponseModel;
import com.example.ldgo.Permissions.AppPermissions;
import com.example.ldgo.R;
import com.example.ldgo.Utility.LoadingDialog;
import com.example.ldgo.WebServices.RetrofitAPI;
import com.example.ldgo.WebServices.RetrofitClient;
//import com.example.ldgo.databinding.ActivityDirectionBinding;
import com.example.ldgo.databinding.ActivityDirectionsBinding;
import com.example.ldgo.databinding.BottomSheetLayoutBinding;
...
public class DirectionsActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private Class<RetrofitAPI> retrofitAPI;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        retrofitAPI = RetrofitAPI.class;
        //retrofitAPI = RetrofitClient.getRetrofitClient().create(RetrofitAPI.class);

        //Skeptical about this line
        bottomSheetLayoutBinding = BottomSheetLayoutBinding.bind(findViewById(R.id.cardLayout));
                    ...
                    if (response.errorBody() == null) {
                        if (response.body() != null) {
                            ...
                            if (response.body().getDirectionRouteModels().size() > 0) {
                                ...
                                Toast.makeText(DirectionsActivity.this, "No route find", Toast.LENGTH_SHORT).show();
                            }
                        } else {
                            Toast.makeText(DirectionsActivity.this, "No route find", Toast.LENGTH_SHORT).show();
                        }
                ...
                new AlertDialog.Builder(this)
                        ...
                        .setPositiveButton("Ok", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                appPermissions.requestLocationPermission(DirectionsActivity.this);
                            }
                        })
                        .create().show();
            } else {
        ...
        fusedLocationProviderClient.getLastLocation().addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    Toast.makeText(DirectionsActivity.this, "Location Not Found", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
